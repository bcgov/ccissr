...
#' Pared down edatopic overlap used for CCISS spatial which ignores phases/variations
#' @param BGC data.table of summarised BGC projections
#' @param E1  Edatopic table
#' @return data.table of site series predictions
#' @import data.table
#' @export
