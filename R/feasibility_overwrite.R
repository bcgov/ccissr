...
feas_update<-read.csv("feas_tables/versioned/Feasibility_v13_6.csv") 
feas_update$X<-NULL
...
write.csv(diffrept, "feas_tables/versioned/tracked_changes/diff_report_v13_6.csv") #rename with version to match update 
