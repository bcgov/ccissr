...
plot_SuitabilityChangeMap(con, bgc_template = bgc_template, outline = bc_ol, spp = "Cw", edatope = "B2", period = "2001_2020", three_panel = FALSE, save_png = TRUE) #For Mia, there is currently no data showing. Not sure why, need to troubleshoot.
```
