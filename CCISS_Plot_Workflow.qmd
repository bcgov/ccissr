...
summary_preds_gcm(dem2, BGCmodel, vars_needed, gcms_cciss, periods_use = c("2021_2040", "2041_2060", "2061_2080", "2081_2100"), max_runs_use = 3L, summarise = FALSE, base_folder = base_path)
...
```{r}
plot_spparea(spp = "Fd", edatope = "B2", bgc_template = bgc_template, fractional = TRUE, by_zone = FALSE, base_folder = base_path)
plot_spparea(spp = "Fd", edatope = "C4", bgc_template = bgc_template, fractional = TRUE, by_zone = FALSE, base_folder = base_path)
```
