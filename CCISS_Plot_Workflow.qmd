...
```{r}
plot_spparea(con, spp = "Fd", edatope = "B2", fractional = TRUE)
plot_spparea(con, spp = "Fd", edatope = "C4", fractional = TRUE)
plot_spparea(con, spp = "Fd", edatope = "D6", fractional = TRUE)
```
