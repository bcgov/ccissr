...
```{r}
bgcs <- vect("BEC13Draft_Simplified.gpkg")
...
plot_2panel(con, spp = "Fd", edatope = "C4", period = "2041_2060", bgc_template = bgc_template, outline = bc_ol, three_panel = FALSE, save_png = FALSE)
```
