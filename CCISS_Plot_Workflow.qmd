...
perexp <- spp_persist_expand(con, spp_list = c("Cw","Fd"), fractional = TRUE) #run for one species at a time if machine can't handle more
...
spp_bubbleplot(perexp, period = "2041_2060", scenario = "ssp245", edatope = "C4") #throwing errors for Mia currently, need to troubleshoot
...
```{r}
plot_spparea(con, spp = "Cw", edatope = "B2", fractional = TRUE, save_png = TRUE)
plot_spparea(con, spp = "Cw", edatope = "C4", fractional = TRUE, save_png = TRUE)
plot_spparea(con, spp = "Cw", edatope = "D6", fractional = TRUE, save_png = TRUE)
