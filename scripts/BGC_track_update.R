...
BGC_update<-read.csv("tables/versioned/WNA_BGCs_v13_5.csv")
BGC_update$X<-NULL
...
write.csv(diffrept, "tables/versioned/tracked_changes/BGCs/diff_report_v13_5.csv") #rename with version to match update 
