...
edat_update<-read.csv("tables/versioned/Edatopic_v13_14.csv") 
edat_update$X<-NULL
...
write.csv(diffrept, "tables/versioned/tracked_changes/edatopic/diff_report_v13_14.csv") #rename with version to match update 
