...
suit_update<-read.csv("tables/versioned/Suitability_v13_31.csv") 
suit_update$X<-NULL
...
write.csv(diffrept, "tables/versioned/tracked_changes/suitability/diff_report_v13_31.csv") #rename with version to match update 
