...
suit_update<-read.csv("tables/versioned/suitability_v13_26.csv") 
suit_update$X<-NULL
...
write.csv(diffrept, "tables/versioned/tracked_changes/suitability/diff_report_v13_26.csv") #rename with version to match update 
