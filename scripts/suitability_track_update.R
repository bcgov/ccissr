...
suit_update<-read.csv("tables/versioned/suitability_v13_18.csv") 
suit_update$X<-NULL
...
write.csv(diffrept, "tables/versioned/tracked_changes/suitability/diff_report_v13_18.csv") #rename with version to match update 
...
updated_readme<- c("# Current table versions ",  "Suitability v13_18 ",        ""               ,
                   "Edatopic v13_11 ",    ""               ,
                   "WNA BGCs v13_2 ",     ""               ,
